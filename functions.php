<?php
function AcmeInc_enqueue() {
    wp_enqueue_style('semanticUI', 'https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css');
...
add_action('wp_enqueue_scripts', 'AcmeInc_enqueue');
